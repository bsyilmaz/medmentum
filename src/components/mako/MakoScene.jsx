  ...
  return (
    <div className="h-full w-full flex items-center justify-center p-8">
      <AnimatePresence mode="wait">
        ...
        >
          {/* Ana Kiosk Görseli */}
          <div className="relative w-[300px] h-[500px] md:w-[400px] md:h-[600px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-3xl shadow-2xl border-4 border-gray-700 overflow-hidden">
            ...
            <motion.div
              ...
              className={`absolute top-8 left-6 right-6 bottom-24 ${config.bgColor} rounded-2xl border-2 border-gray-600 flex flex-col items-center justify-center p-6 transition-all duration-500`}
            >
              {/* İkon */}
              <motion.div
                animate={config.pulse ? {
                ...
                transition={{ duration: 2, repeat: Infinity }}
              >
                <Icon className={`w-24 h-24 md:w-32 md:h-32 ${config.color} mb-4`} strokeWidth={1.5} />
              </motion.div>
              ...
              <motion.p
                ...
                transition={{ duration: 2, repeat: Infinity }}
                className={`text-lg md:text-xl font-bold ${config.color} text-center`}
              >
                {config.label}
              </motion.p>
            ...
            <motion.div
              ...
              className="absolute bottom-6 left-6 right-6 h-16 bg-gray-700 rounded-xl border-2 border-gray-600 flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className={`absolute top-0 left-0 right-0 h-32 bg-gradient-to-b ${config.color.replace('text-', 'from-')} to-transparent opacity-20`}
            />
          </div>
